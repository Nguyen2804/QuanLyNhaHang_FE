        ...
        <div class="container my-5 py-5">
            ...
            <div class="d-md-flex justify-content-between my-5">
                <div>
                    ...
                    <ul class="list-unstyled">
                        <li><iconify-icon class="social-icon text-primary fs-5 me-2" icon="ic:baseline-email"
                                style="vertical-align:text-bottom"></iconify-icon> Nhà Hàng Nguyên Trần</li>
                        <li><iconify-icon class="social-icon text-primary fs-5 me-2" icon="mdi:location"
                                style="vertical-align:text-bottom"></iconify-icon> Thanh Khê, Đà Nẵng</li>
                        ...
                        <li><iconify-icon class="social-icon text-primary fs-5 me-2" icon="ic:baseline-email"
                                style="vertical-align:text-bottom"></iconify-icon> tn2842003@gmail.com</li>
                ...
                <div>
                    ...
                    <ul class="list-unstyled">
                        <li><span class="fw-semibold">Account No: </span> 5660490234</li>
                        <li><span class="fw-semibold">Account Name: </span> Trần Lê Bảo Nguyên</li>
                        <li><span class="fw-semibold">Bank Name: </span> BIDV </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="container border-top">
                    <div class="row mt-3">
                        <div class="col-md-6 copyright">
                            <p>Nhà Hàng Nguyên Trần <a href="#" target="_blank" class="text-decoration-none text-black-50"></a> </p>
                        </div>
